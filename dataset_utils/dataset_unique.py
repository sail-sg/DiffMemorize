...
def open_cifar10_balance(tarball: str, *, max_images: Optional[int], num_classes: Optional[int]):
    images = []
    labels = []
...
def open_dataset(source, *, max_images: Optional[int], num_classes: Optional[int],):
    if os.path.isdir(source):
        ...
        if os.path.basename(source) == 'cifar-10-python.tar.gz':
            return open_cifar10_balance(source, max_images=max_images, num_classes=num_classes)
